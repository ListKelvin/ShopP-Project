...
const Products = [
  ...
  {
    id: 0,
    name: "Chuột Không Dây Xanh ngọc Forter V182",
    price: "$3200",
    liked: "2000",
  },
];
...
const ProDis = ({ disabled }) => {
  return (
    <>
      {Products.map(({ name, price, liked, id, shop }) => {
        return (
          <ProductStyle key={id}>
            ...
            <ProductWidth>
              <Image style={{ opacity: "0.6" }}>
                <ImageItem src={ImgBrand} />
              </Image>
              <ProductName style={{ opacity: "0.6" }}>
                {name}
                <TypoSoldOut>
                  This item is sold out. Please choose another item!
                </TypoSoldOut>
              </ProductName>
            </ProductWidth>
            <OtherWidth>
              <Typo style={{ opacity: "0.6" }}>{price}</Typo>
            </OtherWidth>
            <OtherWidth>
              <Typo>{liked}</Typo>
            </OtherWidth>
