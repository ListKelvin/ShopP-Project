...
const AvatarBox = () => {
    return(
        <AvatarBoxStyle>
            <Avatar alt="Remy Sharp" src="/static/images/avatar/1.jpg" sx={{ width: {xxl: "100px", xl: "90px", lg: "80px", md: "70px", sm: "60px", xs: "50px"}, height: {xxl: "100px", xl: "90px", lg: "80px", md: "70px", sm: "60px", xs: "50px"}}} />
            ...
            <ButtonAvatar
                ...
                >
                <AddAPhotoIcon style = {{color: "#000"}} sx = {{width:{xs: "18px", sm: "20px", md: "22px"}}}/>
